...
import { MoreVertical, Car, User, X, ArrowLeft } from "lucide-react";
    ...
    return (
      <div className="bg-white rounded-2xl border border-[#F3E8EB] p-8 text-center max-w-md mx-auto mt-12 shadow-xs">
        ...
        <p className="text-gray-500 text-sm mt-2">
          {vehicleError || "Vehículo no disponible."}
        </p>
        <button
          onClick={() => navigate(-1)}
          ...
          className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold tracking-wide border ${
            ...
            item.estado?.toLowerCase() === "completada"
              ...
              : item.estado?.toLowerCase() === "pendiente"
                ...
                : item.estado?.toLowerCase() === "en camino" ||
                    item.estado?.toLowerCase() === "en viaje"
    ...
    <div className="space-y-8 animate-fade-in select-none">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            ...
            <span className="font-extrabold text-gray-750">
              {vehicleProfile.fullName}
            </span>
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-1.5 bg-[#FAF5F6] border border-[#F9EBEC] py-0.5 px-2 rounded-full">
                ...
                <div className="w-4.5 h-4.5 rounded-full overflow-hidden border border-primary/20 bg-gray-100 flex items-center justify-center shrink-0">
                  {vehicleProfile.foto_driver ? (
                    <img
                      src={vehicleProfile.foto_driver}
                      alt={vehicleProfile.driverName}
                      className="w-full h-full object-cover"
                    />
                  ) : (
        ...
        <div className="bg-white p-6 rounded-2xl border border-[#F3E8EB] shadow-xs flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h3 className="text-4xl font-black text-gray-950 leading-none">
              {vehicleTotalTrips}
            </h3>
            <p className="text-[10px] text-gray-450 font-bold mt-1.5 leading-normal">
              De {globalStats.totalToday} viajes hechos por todos los vehículos
              hoy
            </p>
          </div>
        </div>
