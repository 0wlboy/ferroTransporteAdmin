        ...
        <div className={`flex flex-col w-full ${className}`}>
            ...
            <div className="relative w-full">
                <input
                    ...
                    required={required}
                    disabled={disabled}
                    className={`w-full pl-4 pr-10 py-3 rounded-xl border text-sm transition-all focus:outline-none focus:ring-2 disabled:bg-gray-55 disabled:cursor-not-allowed ${
                        error
