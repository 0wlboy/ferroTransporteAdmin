    ...
    return (
        <div className={`flex flex-col items-center gap-2 select-none ${className}`}>
            <div
                ...
                className="w-28 h-28 rounded-full overflow-hidden border-4 border-primary bg-gray-50 flex items-center justify-center cursor-pointer group shadow-md relative transition-transform hover:scale-102"
            >
                {/* Image Preview */}
                {previewUrl ? (
                    <img
