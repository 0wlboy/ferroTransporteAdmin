import { CarView, DriverView, PassengerView, PetitionsView, LocationView, Login, Register, UserActivity, CarActivity, Home, AddPassenger, AddCar, AddDriver, AddLocation, UpdateAdminProfile } from "./pages/exporter";
