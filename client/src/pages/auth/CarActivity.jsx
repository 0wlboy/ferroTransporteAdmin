...
export default function CarActivity() {
    ...
    if (vehicleError || !vehicleProfile) {
        return (
            <div className="bg-white rounded-2xl border border-[#F3E8EB] p-8 text-center max-w-md mx-auto mt-12 shadow-xs">
                ...
                <p className="text-gray-500 text-sm mt-2">{vehicleError || "Vehículo no disponible."}</p>
                <button
                    onClick={() => navigate(-1)}
        ...
        },
        {
            ...
            render: (item) => (
                <div className="text-xs">
                    <p className="font-semibold text-gray-755">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                        Actividad del Modelo: <span className="font-extrabold text-gray-750">{vehicleProfile.fullName}</span>
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#F3E8EB] shadow-xs flex justify-between items-center">
                    <div className="space-y-2.5">
                        ...
                        <div>
                            <p className="text-[9px] font-bold text-gray-400 uppercase leading-none">PLACA:</p>
                            <div className="inline-block border border-gray-200 bg-gray-50 px-3 py-1 rounded-lg text-sm font-extrabold text-gray-800 tracking-wider font-mono mt-1">
                                {vehicleProfile.placa}
                            </div>
                        </div>
                        <div className="flex items-center gap-2 mt-1">
                            <span className="text-[9px] font-bold text-gray-400 uppercase">CONDUCTOR</span>
                            <div className="flex items-center gap-1.5 bg-[#FAF5F6] border border-[#F9EBEC] py-0.5 px-2 rounded-full">
                                <span className="text-[10px] font-extrabold text-primary">{vehicleProfile.driverName}</span>
                                <div className="w-4.5 h-4.5 rounded-full overflow-hidden border border-primary/20 bg-gray-100 flex items-center justify-center shrink-0">
                                    {vehicleProfile.foto_driver ? (
                                        <img src={vehicleProfile.foto_driver} alt={vehicleProfile.driverName} className="w-full h-full object-cover" />
                                    ) : (
                    ...
                    <div className="w-16 h-16 rounded-2xl overflow-hidden border border-gray-150 shrink-0 bg-gray-50 flex items-center justify-center shadow-xs">
                        {vehicleProfile.foto_vehiculo ? (
                            <img
                                src={vehicleProfile.foto_vehiculo}
                                alt={vehicleProfile.fullName}
                                className="w-full h-full object-cover"
                            />
                        ) : (
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#F3E8EB] shadow-xs flex flex-col justify-between">
                    ...
                    <div className="mt-4">
                        <h3 className="text-4xl font-black text-gray-950 leading-none">{vehicleTotalTrips}</h3>
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#F3E8EB] shadow-xs flex flex-col justify-between">
                    ...
                    <div className="mt-4">
                        <h3 className="text-4xl font-black text-gray-950 leading-none">{vehicleCancelledTrips}</h3>
                        <p className="text-[10px] text-red-655 font-bold mt-1.5 leading-normal bg-red-50/50 py-0.5 px-1.5 rounded-md border border-red-100/30 inline-block">
