...
import { MoreVertical, ClipboardList, Car, XCircle, User } from "lucide-react";
  ...
  const headers = [
    ...
    },
    {
      ...
      render: (item) =>
        item.driverName ? (
          <div>
            <p className="font-semibold text-gray-700">{item.driverName}</p>
            ...
            {item.placa_vehiculo && (
              <p className="text-[10px] text-gray-400 font-medium mt-0.5">
                Placa:{" "}
                <span className="font-semibold text-gray-505">
                  {item.placa_vehiculo}
                </span>
              </p>
            )}
