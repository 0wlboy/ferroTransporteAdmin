...
export default function UpdateAdminProfile() {
    ...
    const [avatarPreview, setAvatarPreview] = useState(
        currentUser?.avatar || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=250&auto=format&fit=crop"
    );
    ...
    if (loadingProfile) {
        return (
            <div className="flex flex-col items-center justify-center p-12 min-h-[400px]">
                ...
                <p className="text-gray-500 text-sm mt-4">Cargando información del perfil...</p>
            </div>
        );
    }
                    ...
                    <div className="flex flex-col items-center gap-6 text-center w-full">
                        ...
                        <div className="space-y-3 w-full">
                            ...
                            <p className="text-[10px] text-gray-400 font-semibold max-w-[200px] mx-auto leading-normal">
                                Admite imágenes JPG, PNG o WEBP. Tamaño recomendado de 250x250px.
                            </p>
                        </div>
                    </div>
                </div>
